 ...
 * 작성자: 박진
 * 변경이력:
 *   2026-05-11 박진 — 프론트 기반 백엔드 대량 수정에 맞춘 프론트엔드 호환성 스모크 테스트 신설, 이후 투데이 인사이트 및 챗봇 연동 반영
 *   2026-05-22 안가은 — 홈화면 그래프 데이터 연동 검증 추가
 *   2026-06-09 최종민 — today-insight cron-generate 추가 검증
 */
